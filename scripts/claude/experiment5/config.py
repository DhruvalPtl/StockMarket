...
class BotConfig:
    ...
    # --- STRATEGY D SETTINGS (LIQUIDITY SWEEP) ---
    # Update these 2 numbers every morning before running the bot!
    PREV_DAY_HIGH = 26187.00  # Example: Replace with yesterday's real High
    PREV_DAY_LOW  = 25969.00  # Example: Replace with yesterday's real Low

    # Sweep Rules
    SWEEP_MIN_POINTS = 5.0    # Price must break level by at least 5 points
    SWEEP_MAX_POINTS = 40.0   # If it breaks by >20, it might be a real breakout (don't fade)
    ...
    STRATEGIES_TO_RUN = ["ORIGINAL", "STRATEGY_A", "STRATEGY_B", "STRATEGY_C","STRATEGY_D"]
    ...
    BASE_LOG_PATH = r"D:\\StockMarket\\StockMarket\\scripts\\claude\\expriment5\\logs"
