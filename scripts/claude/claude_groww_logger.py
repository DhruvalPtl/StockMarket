...
class GrowwLogger:
    def __init__(self):
        ...
        self.bot_log_file = f"{base_path}\\claude_bot_log\\Claude_Bot_Log_{date_str}.csv"
        self.trade_file = f"{base_path}\\claude_trade_book\\Claude_Trade_Book_{date_str}.csv"
