    ...
    def run(self):
        ...
        try:
            while True:
                ...
                # Market hours check (9:15 AM to 15:30 PM)
                ...
                # No new entries after 15:20 (5 min buffer before forced exit)
                ...
                # Force exit if position open at 15:25
                if self.active_position and now >= force_exit_time: 
